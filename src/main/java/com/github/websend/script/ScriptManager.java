...
public class ScriptManager {
    ...
    public ScriptManager() {
        scriptsDir = Main.getScriptsDir();
        compiledDir = new File(Main.getScriptsDir(), "compiled");
    ...
    private boolean loadClasses(Script container) {
        ...
        try {
            ...
            for (File cur : classFiles) {
                ...
                if (curClass.getName().toLowerCase().equals("main") && ScriptInterface.class.isAssignableFrom(curClass)) {
                    container.setMainClass((Class<? extends ScriptInterface>)curClass);
                }
